<template>
  ...
  <Alert :alert="alert" />
        ...
        <div>
          ...
          <b-container v-for="comment in comments" v-bind:key="comment" class="border border-secondary m-2 p-2">
            <b-row>
              <b-col>
                <b-avatar class="mr-3"/>
            ...
            <b-row>
              <b-col>
                <b-icon icon="star-fill" variant="warning" font-scale="1" v-for="n in comment.rating" v-bind:key="n"/>
